...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		isPlaying = false;
		((ChatDetailActivity) activity).playMsgId = null;
	...
	public void playVoice(String filePath) {
		...
		((ChatDetailActivity) activity).playMsgId = message.getMsgId();
	...
	public void onClick(View v) {
		...
		if (isPlaying) {
			if (((ChatDetailActivity) activity).playMsgId != null && ((ChatDetailActivity) activity).playMsgId.equals(message.getMsgId())) {
