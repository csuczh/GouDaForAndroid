...
public class DbOpenHelper extends SQLiteOpenHelper{
	...
	private static final String USERNAME_TABLE_CREATE = "CREATE TABLE "
			...
			+ UserDao.COLUMN_NAME_LNG+" double, "
			+ UserDao.COLUMN_NAME_LAT+" double, "
			+ UserDao.COLUMN_NAME_USER_ID+" INTEGER, "
	...
	private static final String INIVTE_MESSAGE_TABLE_CREATE = "CREATE TABLE "
			...
			+ InviteMessgeDao.COLUMN_NAME_SEX+" INTEGER, "
			+ InviteMessgeDao.COLUMN_NAME_LNG+" double, "
			+ InviteMessgeDao.COLUMN_NAME_LAT+" double, "
			+ InviteMessgeDao.COLUMN_NAME_USER_ID+" INTEGER, "
	...
	private static String getUserDatabaseName() {
        return  HXSDKHelper.getInstance().getHXId() + "_dg.db";
    }
	...
	{
           context.deleteDatabase(HXSDKHelper.getInstance().getHXId() + "_demo.db");
	}
