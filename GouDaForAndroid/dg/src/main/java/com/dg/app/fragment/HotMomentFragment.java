...
public class HotMomentFragment extends MomentsBaseListFragment<Moment>
{
    private DGUser user;

    protected static final String TAG = HotMomentFragment.class.getSimpleName();

    private static final String CACHE_KEY_PREFIX = "hot_moments_list_";
    ...
    protected void sendRequestData() {
        ...
        if(user!=null&&user.getUserid()!=0) {
            DGApi.hotMoments(user.getUserid(), mCurrentPage, MomentsBaseListFragment.PAGE_SIZE, mHandler);
        }else{
