...
public class ApiHttpClient {
    ...
    public final static String HOST = "www.goumatch.com";
    private static String API_URL = "http://www.goumatch.com/Api/%s";
    public final  static String IMAGE_URL = "http://www.goumatch.com";
