...
@SuppressLint("DgApi")
public abstract class DogKnowMoreBaseListFragment<T extends Entity> extends BaseFragment
    ...
    protected int getLayoutId() {
        return R.layout.fragment_dk_more_pull_refresh_listview;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (args != null) {
                ...
                category_id=args.getInt(BUNDLE_KEY_TOPIC_ID,0);
                keyword=args.getString(BUNDLE_KEY_SEARCH_ID,"");
                Toast.makeText(getActivity(), device + " " + city_id+category_id, Toast.LENGTH_LONG).show();
