...
public class PagerSlidingTabStrip extends HorizontalScrollView implements
	...
	private MapView mapView; // ViewPager
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (tabViewGroup != null) {
			...
			TextView title=(TextView)tabViews.get(currentPosition).findViewById(R.id.tab_title);
			title.setTextColor(getResources().getColor(R.color.actionbar_red));
	...
	public void onClick(View v) {
		...
		for(int i=0;i<tabViews.size();i++)
		{
			if(i!=index)
			{
				title=(TextView)tabViews.get(i).findViewById(R.id.tab_title);
				title.setTextColor(getResources().getColor(R.color.actionbar_normal));
			}
			else {
				title=(TextView)tabViews.get(i).findViewById(R.id.tab_title);
				title.setTextColor(getResources().getColor(R.color.actionbar_red));
